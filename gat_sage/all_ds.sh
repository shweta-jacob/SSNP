...
# hpo-metab
python GLASSTest.py --use_nodeid --use_seed --repeat 10 --dataset hpo_metab --model 2 --m 5 --M 1 --views 5 --diffusion --device 0 --use_gat_conv
python GLASSTest.py --use_nodeid --use_seed --repeat 10 --dataset hpo_metab --model 2 --m 5 --M 1 --views 5 --diffusion --device 0 --use_sage_conv
