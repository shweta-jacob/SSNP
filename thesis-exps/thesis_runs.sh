python GLASSTest.py --use_nodeid --use_seed --repeat 10 --dataset ppi_bp --model 2 --samples 1 --m 8 --M 1 --stochastic --diffusion --device 0
...
python GLASSTest.py --use_one --use_seed --repeat 10 --dataset density --model 2 --samples 1 --m 5 --M 5 --stochastic --device 2
python GLASSTest.py --use_one --use_seed --repeat 10 --dataset component --model 2 --samples 1 --m 100 --M 10 --stochastic --device 3