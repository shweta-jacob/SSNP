...
class SpectralNet(torch.nn.Module):
    ...
    def forward(self, x, edge_index, edge_weight, pos, subgraph_assignment):
        ...
        subg_embs = x[subg_nodes]
        subg_embs = global_mean_pool(subg_embs, batch)
        ...
        return self.preds[0](torch.cat([cont_labels], dim=-1)), subg_embs, cont_labels, mc_loss1, o_loss1, ent_loss1, softmax_s
